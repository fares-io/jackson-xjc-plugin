...
public class EnumNoValueAnnotationTest extends AbstractJacksonPluginTest {

  @Override
  public File getSchemaDirectory() {
    return new File(getBaseDir(), "src/test/resources/schemas/EnumNoValue");
  }

  @Override
  protected File getClassFile(File genDir) {
    return new File(genDir, "testnovalue/VehicleType.java");
  }
